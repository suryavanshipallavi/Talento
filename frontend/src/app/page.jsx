        ...
        <div className="bg-white py-6 sm:py-8 lg:py-12">
          <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <div className="grid gap-x-4 gap-y-8 sm:grid-cols-2 md:gap-x-6 lg:grid-cols-3 xl:grid-cols-4">
              ...
              <div key={job._id}>
                <a
                  href={userLoggedIn ? `/vacancy-details/${job._id}` : "/login"}
                  className="group relative mb-2 block h-96 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3"
                >
                  <img
                    src={job.company?.logo && job.company.logo !== "logo_placeholder.png"
                ...
                <div className="flex items-start justify-between gap-2 px-2">
                  <div className="flex flex-col">
                    ...
                    <span className="text-gray-500">by {job.company?.compName || 'Unknown Company'}</span>
                  </div>
