...
const Navbar = () => {
  ...
  const { companyLoggedIn, companyLogout, currentCompany } = useCompanyContext();
  const { userLoggedIn, userLogout, currentUser } = useUserContext();

  const isLoggedIn = companyLoggedIn || userLoggedIn;
  ...
  const showLoginOption = () => {
    if (companyLoggedIn) {
      return <>
        ...
        <li>
          <span className="block py-2 pr-4 pl-3 text-white font-semibold md:p-0">
        ...
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          <a href="/" className="flex items-center">
            <span className="self-center flex text-xl mt-2 font-semibold whitespace-nowrap text-white">
              <img src='/logo.png' className='w-12 h-12 mr-3' /><p className='mt-2'>TALENTO</p>
            </span>
          </a>
